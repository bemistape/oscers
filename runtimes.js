...
const SCORE_URL = "YOUR_APPS_SCRIPT_URL";
...
let playerName = "";
// We'll store the reaction text in a variable for simultaneous display
let pendingReaction = "";
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  // Overlays: close either => close both => proceed to next round
...
function onSubmitRound(){
  ...
  // Also show the reaction overlay simultaneously
